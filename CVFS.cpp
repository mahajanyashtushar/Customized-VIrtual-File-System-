...
UFDT UFDTArr[50]; // gloable variables
SUPERBLOCK SUPERBLOCKobj; // gloable variables
PINODE head = NULL; // gloable variables
...
void man(char* name)
{
    ...
    if(strcmp(name,"create")== 0)
    {
        ...
        // Add more desctiption hear..
    }
    else if(strcmp(name,"read")== 0)
    {
        printf("Description : Used to read data form regular file \n");
        printf("Usage : read File_name No_Of_Btes_To_Read\n");
    ...
    {
        printf("Desctiption : used to display information fo file \n");
        printf("Usage : stat File_name\n");
    }
    else if(strcmp(name,"fstat")==0)
    {
        printf("Description : used to display information of file \n");
        printf("Usage : stat file_Desctiptor\n");
    }
    else if (strcmp(name,"truncate")== 0)
    {
        printf("Desctiption : Used to remove data form file \n");
...
void DisplayHelp()
{
    ...
    printf("exit : To Terninate file system\n");
    printf("stat : To Display information of file using name\n");
    printf("fstat :To Display information fo file using file desctiptor\n");
    printf("truncate : To remove all data fron file \n");
...
PINODE Get_Inode(char * name) // linke no 162 // this function is used to get the inode numeber of the file
{
    PINODE temp = head;
    int i = 0;
...
void CreateDILB()
{
    ...
    printf("DILB created successfullsy \n");
}
...
{
    int i = 0; // first 3 reserved thevlele(0,1,2) ani next vaprle ase vatave manun 
    PINODE temp = head;
...
int fstat_file(int fd)//509
{
    ...
    printf("Link Count :%d\n",temp->LinkCount);
    printf("Recerence count :%d\n",temp->ReferenceCount);

    if(temp->permission == 1)
    {
        printf("File permiassion :Read only \n");
    }
...
int main() //586
{
    ...
    // 4 he no of curnels ahet ani 
    // 80 manje cmd vr apan jeva command takto teva eka line madhe 80 characrots basu shakatat manun 80
    //1024 manje standard file chi size 1024 byet aste temule apn te ghetle 

    InitialiseSuperBlock();// go to Line No -> 214
    CreateDILB();// go to linke no -> 181

    //shell
    while(1)
    {
        fflush(stdin); // adhi che je input ghetale hote te kadhun taknesathi fflush vaparle
        strcpy(str,"");// copy the string( the function strcpy accept the two parameters 1 is destination string and 2 is sourse strig)
        ...
        if(count == 1)
        {
            //printf("the count is 1\n");
            if(strcmp(command[0],"ls") == 0)
            {
                //printf("Inside ls command... \n");
                ls_file(); // go to line no 483
            }
            else if(strcmp(command[0],"closeall") == 0)
            {
                CloseAllFile(); // go to linke no 411
                printf("All files closed Successfully \n");
                //continue;
            }
            else if(strcmp(command[0],"clear") == 0)
            {
                system("cls"); // This is one of the command which is platform dependent command
                continue;
            }
            ...
            else if(strcmp(command[0],"exit")==0)
            {
                ...
                break; // ya mule apan direct while loop che baher padlo 
            }
            else
            {
        ...
        else if(count == 2)
        {
            ...
            else if(strcmp(command[0],"write")==0)
            {
                ...
                if(ret == 0)
                {
                    printf("ERROR : Incorrect paramentrs\n");
                    continue;
                }
            ...
            else if(strcmp(command[0],"truncate")==0)
            {
                ...
                if(ret == -1)
                    printf("Error : Incorretct paramenters\n");
        ...
        else if(count == 3)
        {
            ...
            {   
                ...
                if(ret >=0)
                printf("File is successfully creaated with file descriptor :%d \n",ret);
                else if(ret ==-1)
                printf("ERRPR : Incorrect paramentrs \n");
                else if(ret == -2)
            ...
            else if(strcmp(command[0],"open")==0)
            {
                ...
                if(ret >=0)
                printf("File is successfully opened with file desctiptor :%d\n",ret);
                if(ret == -1)
               printf("ERROR: Incorrect paramenters \n");
               if(ret == -2)
...
/*
 ...
 1-> Break mule direct loop break hoto (for or while) if else  statement la kahihi farak padat nahi
 2-> 
 */